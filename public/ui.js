			...
			React.createElement(
				...
				React.createElement(
					...
					window.settings.teamEvent ? React.createElement(
						'div',
						{ className: 'name' },
						driver.name.substr(driver.name.indexOf(" ") + 1).toUpperCase()
					) : React.createElement(
						'div',
						{ className: 'name' },
				...
				UI.state.controllerOptions.options.showLiveryPreview.value === "true" ? React.createElement(
					'div',
					{ className: 'vehicle' },
					React.createElement('img', { src: `/render/${driver.liveryId}/small/?type=livery` })
				) : null,
				React.createElement(
					'div',
					{ className: 'manufacturer' },
					React.createElement('img', { src: '/render/' + driver.manufacturerId + '/small/?type=manufacturer' })
				)
			),
			React.createElement(
				'div',
				{ className: 'bottom' },
				window.settings.teamEvent ? null : React.createElement(
					'div',
					{ className: 'team' },
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement('img', { src: `/render/${info.trackId}/big/?type=track` }),
					React.createElement(
						'div',
						{ className: 'trackLogo' },
						!window.settings.offline && React.createElement('img', { src: trackLogo })
					)
				),
				React.createElement(
					'div',
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						window.settings.teamEvent ? React.createElement(
							'div',
							{ className: 'teamEventName' },
							driverInfo.name.substr(driverInfo.name.indexOf(" ") + 1).toUpperCase()
						) : React.createElement(
							'div',
							{ className: 'name' },
					...
					UI.state.controllerOptions.options.showTyreCompound.value === "true" && r3eTyreDB.classes[driverInfo.classId] != null ? React.createElement(
						...
						'div',
						{ className: 'manufacturer' },
						React.createElement('img', { src: '/render/' + driverInfo.manufacturerId + '/small/?type=manufacturer' })
					),
					UI.state.controllerOptions.options.showLiveryPreview.value === "true" ? React.createElement(
						'div',
						{ className: 'vehicle' },
						React.createElement('img', { src: `/render/${driverInfo.liveryId}/small/?type=livery` })
					) : null
				),
				React.createElement(
					'div',
...
var WidgetManager = React.createClass({
	...
	onClickDriver: function (e) {
		...
		if (UI.state.activeWidgets[this.props.widget.elementName].elementName === compareRaceWidgetId && UI.state.activeWidgets[this.props.widget.elementName].active === true) {
			UI.state.activeWidgets[focusedDriverWidgetId].active = false;
		} else if (UI.state.activeWidgets[this.props.widget.elementName].elementName === focusedDriverWidgetId && UI.state.activeWidgets[this.props.widget.elementName].active === true) {
...
var TabledDriver = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement('img', { className: 'manufacturer', src: '/render/' + driver.manufacturerId + '/small/?type=manufacturer' }),
